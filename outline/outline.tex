...
\par
Previous studies have shown that increases in world food prices can harm nutrition in developing countries. It has been noted that land-holders may gain from increased food prices if they are net-sellers of food. I argue that even if the houshehold is a net-buyer, holding land may help families buffer the effect of high food prices. I also argue that trade costs, meaning the transportation costs between a locale and the world market, mitigate the effect of world price shocks. I hope to estimate the magnitude of the effect of food price shocks, in order to compare it with the already studied mitigation of local producitivity shocks. The role of land is particularly important given the general pattern of greater concentration of land ownership in more commercialized communities.
