...
\par
Previous studies have shown that fluctuations in world food prices affect nutrition in developing countries. I make two novel arguments. One, that having the right to use land mitigates the effect of world price shocks. Two, that trade costs, meaning the transportation costs between a locale and the world market, mitigate the effect of world price shocks. These hypotheses are not particularly surprising, but their magnitude is not well understood relative to the magnitude of local shocks. The role of land is particularly important given the general pattern of greater concentration of land ownership in more commercialized communities.
...
\begin{itemize}
	\item The effect of an increase in food prices should be different from that of a decrease in food prices. Households are credit constrained. While they may be short of food during a period of high prices, they will not have a corresponding increase in food consumption when prices are low.
	...
	\item Even if we can measure trade costs, they will be correlated with other variables of interest. Thus, the second level cannot be interpreted causally-- it would be suggestive.
\end{itemize}

\includepdf[pages=-,pagecommand={},width=\textwidth]{/home/friend/thesis/outline/figures}
\end{document}
