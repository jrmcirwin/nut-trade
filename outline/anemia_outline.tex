...
I will explore the effect of commodity price shocks during pregnancy on infant anemia. Anemia has a strong inter-generational component. Iron is passed from mother to fetus, but cannot be transmitted through breast-milk. Thus, anemia early in life is largely determined by maternal bio-availability of iron\footnote{And certain other micro-nutrients.} during pregnancy. Female anemia is a major problem around the world, and is a self-reinforcing cycle. \par
...
\begin{itemize}
	...
	\item The effect of increases in food prices differ across regions because of both production and consumption patterns. If a region is a net-exporter of maize, then an increase in the price of maize will lead to a proportionate increase in real income in terms of other goods. On the demand side, if a household does not consume a certain product (e.g. beef for Hindus) then an increase in the price of that good should have no, or little, effect. Thus, one could create weights at the region or household level (depending on the richness 
\end{itemize}

\section{Credit Constraints}
Access to credit would allow households to smooth consumption across periods of high and low prices. Food consumption would still have negative relationship with price, as households substitute between goods, but there would be no reason to believe that price \emph{increases} have a different effect than \emph{decreases}. If households had access to credit, then the level of price, rather than the volatility would be the key determinant of nutrition. \par

However, it is widely known that households in both the developed and developing world do not have access to credit. In this case, the effect of a decrease in price will be different than that of an increase in price. For low prices, real income is great and the household can decide whether to spend that real income or save it for a future period. For high prices, however, the household cannot borrow money in order to maintain their standard of living, meaning it must fall. \par

A credit constraint need not bind all the time. Instead, it will only kick-in when the price reaches a certain level. Therefore, on the individual household level, we would expect to see a relatively flat relationship between food price and anemia until a certain threshold where the credit constraint binds and anemia increases swiftly.
The threshold at which the credit constraint binds will differ across households. Aggregating would result in a more gradual relationship, but the effect of price would still be increasing in price.
\section{Setting}
...
\section{First Steps}
I have acquired the anemia and price data for Senegal. The only prices I have are sorghum, millet and rice. I will weight these by their iron content and create a single price index. I will then divide the price into 50 bins. Each infant will have a treatment assigned to them as the number of months in-utero which they were exposed to each bin. 
